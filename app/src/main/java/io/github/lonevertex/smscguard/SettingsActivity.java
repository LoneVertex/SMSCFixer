...
public class SettingsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        primaryEdit.setText(prefs.getString(SmscConfigSchema.KEY_PRIMARY_SMSC, SmscGuard.DEFAULT_SMSC_PRIMARY));
        secondaryEdit.setText(prefs.getString(SmscConfigSchema.KEY_SECONDARY_SMSC, SmscGuard.DEFAULT_SMSC_SECONDARY));
        ...
        saveButton.setOnClickListener(v -> {
            ...
            String primary = SmscConfigSchema.normalizeSmscOrDefault(rawPrimary, SmscGuard.DEFAULT_SMSC_PRIMARY);
            String secondary = SmscConfigSchema.normalizeSmscOrDefault(rawSecondary, SmscGuard.DEFAULT_SMSC_SECONDARY);
